...
test_that("averaging windows work", {
  ...
  testresult <- c(mean(testvector[1:5]), mean(testvector[2:6]),
  ...
  expect_identical(length(result), length(testvector))
  expect_type(result, "double")
  testresult <- c(mean(testvector[1:1]), mean(testvector[1:2]),
  ...
  expect_identical(length(result), length(testvector))
  expect_type(result, "double")
  testresult <- c(mean(testvector[1:3]), mean(testvector[1:4]),
                  mean(testvector[1:5]), mean(testvector[2:6]),
                  mean(testvector[3:7]), mean(testvector[4:8]),
                  mean(testvector[5:9]), mean(testvector[6:10]),
                  mean(testvector[7:10]), mean(testvector[8:10]))
...
test_that("summing windows work", {
  ...
  testresult <- c(sum(testvector[1:5]), sum(testvector[2:6]),
  ...
  expect_identical(length(result), length(testvector))
  expect_type(result, "integer")
  testresult <- c(sum(testvector[1:1]), sum(testvector[1:2]),
  ...
  expect_identical(length(result), length(testvector))
  expect_type(result, "integer")
  testresult <- c(sum(testvector[1:3]), sum(testvector[1:4]),
                  sum(testvector[1:5]), sum(testvector[2:6]),
                  sum(testvector[3:7]), sum(testvector[4:8]),
                  sum(testvector[5:9]), sum(testvector[6:10]),
                  sum(testvector[7:10]), sum(testvector[8:10]))
...
test_that("pasting windows work", {
  ...
  result <- moving_fn(testvector, w = 5, fun = paste0, side = "right",
                      collapse = '')
  expect_identical(length(result), length(testvector))
  expect_type(result, "character")
  testresult <- c(paste0(testvector[1:5], collapse = ''),
  ...
  result <- moving_fn(testvector, w = 5, fun = paste0, side = "left",
                      collapse = '')
  expect_identical(length(result), length(testvector))
  expect_type(result, "character")
  testresult <- c(paste0(testvector[1:1], collapse = ''),
  ...
  result <- moving_fn(testvector, w = 5, fun = paste0, side = "c",
                      collapse = '')
  expect_identical(length(result), length(testvector))
  expect_type(result, "character")
  testresult <- c(paste0(testvector[1:3], collapse = ''),
                  paste0(testvector[1:4], collapse = ''),
                  paste0(testvector[1:5], collapse = ''),
                  paste0(testvector[2:6], collapse = ''),
                  paste0(testvector[3:7], collapse = ''),
